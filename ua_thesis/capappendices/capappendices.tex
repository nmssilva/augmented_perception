...
This dissertation code is available on github to be used by possible next contributors in the ATLASCAR project:

\begin{itemize}
	\item \texttt{https://github.com/nmssilva/augmented\_perception}
\end{itemize}
